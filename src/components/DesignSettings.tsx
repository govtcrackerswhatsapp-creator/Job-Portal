  ...
  return (
    <div>
      ...
      <div className="flex items-center gap-2">
        <input type="color" value={value || '#000000'} onChange={(e) => onChange(e.target.value)} className="w-10 h-10 shrink-0 rounded-lg border border-zinc-200 bg-white cursor-pointer p-0.5" />
        <input className={inputCls + ' flex-1 min-w-0'} value={value} onChange={(e) => onChange(e.target.value)} placeholder="#000000" />
          ...
          <div className="space-y-2 pt-2">
            {images.map((url, i) => (
              <div key={i} className="flex items-center gap-2">
                ...
                <input className={inputCls + ' flex-1 min-w-0'} value={url} onChange={(e) => updateImage(i, e.target.value)} placeholder="https://i.ibb.co/..." />
          ...
          <div className="pt-4 mt-2 border-t border-zinc-100">
            ...
            <div className="space-y-2">
              {mobileImages.map((url, i) => (
                <div key={i} className="flex items-center gap-2">
                  <ImageIcon className="w-4 h-4 text-zinc-400 shrink-0" />
                  <input className={inputCls + ' flex-1 min-w-0'} value={url} onChange={(e) => updateMobileImage(i, e.target.value)} placeholder="https://i.ibb.co/... (portrait image)" />
        ...
        <Section title="Reviews Section">
          ...
          <div className="space-y-3 pt-1">
            {reviews.map((r, i) => (
              <div key={i} className="bg-zinc-50 rounded-lg p-3 border border-zinc-100 space-y-2">
                <div className="flex items-center gap-2">
                  <input className={inputCls + ' flex-1 min-w-0'} value={r.name} onChange={(e) => updateReview(i, 'name', e.target.value)} placeholder="Reviewer name" />
                  <input className={inputCls + ' flex-1 min-w-0'} value={r.title} onChange={(e) => updateReview(i, 'title', e.target.value)} placeholder="Title / role" />
            ...
            <div className="space-y-2">
              {links.map((l, i) => (
                <div key={i} className="flex items-center gap-2 flex-wrap sm:flex-nowrap">
                  ...
                  <input className={inputCls + ' w-full sm:w-44 shrink-0'} value={l.label} onChange={(e) => updateLink(i, 'label', e.target.value)} placeholder="Link text (e.g. Privacy Policy)" />
                  <input className={inputCls + ' flex-1 min-w-0'} value={l.url} onChange={(e) => updateLink(i, 'url', e.target.value)} placeholder="https://... (hosted document URL)" />
