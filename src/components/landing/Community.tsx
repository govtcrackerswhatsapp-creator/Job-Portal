...
export default function Community({ settings }: { settings: LandingSettings }) {
  ...
  if (links.length === 0) return null; // hide section until admin adds links
  ...
  return (
    <section id="community" className="max-w-5xl mx-auto px-4 py-16 scroll-mt-24">
      <div className="text-center mb-10">
        ...
        {settings.communitySubtext && <p className="text-zinc-500 mt-2 max-w-xl mx-auto">{settings.communitySubtext}</p>}
      </div>
