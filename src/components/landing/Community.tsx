import { Instagram, Facebook, Twitter, Youtube, Linkedin, Github, Send, MessageCircle, Globe, Mail, Link as LinkIcon, LucideIcon } from 'lucide-react';
  ...
  return (
    <section id="community" className="max-w-5xl mx-auto px-4 py-16 scroll-mt-24">
      <div className="text-center mb-10">
        ...
        {settings.communitySubtext && (
          <p className="text-zinc-500 mt-2 max-w-xl mx-auto">{settings.communitySubtext}</p>
        )}
      </div>
        ...
        {links.map((link, i) => {
          ...
          return (
            ...
            >
              ...
              <span className="text-xs font-medium text-zinc-500 group-hover:text-zinc-800 transition">
