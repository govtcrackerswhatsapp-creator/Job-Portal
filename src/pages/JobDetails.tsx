...
import { ArrowLeft, Calendar, GraduationCap, Users, Lock, Loader2, FileText, BookOpen, Sparkles } from 'lucide-react';
...
export default function JobDetails() {
  ...
  const hasPremium = !!(job.examDetails?.trim() || job.studyMaterial?.trim() || (job.customSections && job.customSections.length > 0));
  ...
  return (
    <div className="p-6 md:p-8 max-w-3xl mx-auto">
      ...
      {/* Basic info (open to all) */}
      <div className="bg-white rounded-2xl shadow-soft p-6 mb-4">
        <h2 className="font-heading text-base font-semibold text-zinc-900 mb-4">Overview</h2>
      ...
      {hasPremium && (
        canAccess ? (
          ...
          <div className="bg-gradient-to-br from-[#8b2df2]/5 to-[#00b4d8]/5 border border-[#8b2df2]/20 rounded-2xl p-8 text-center">
            ...
            <h3 className="font-heading text-lg font-bold text-zinc-900">Premium content locked</h3>
            <p className="text-sm text-zinc-500 mt-2 max-w-sm mx-auto">
              Exam details, study material, and more are available to subscribers. Unlock full access to every job.
            </p>
            <Link
              to="/subscribe"
