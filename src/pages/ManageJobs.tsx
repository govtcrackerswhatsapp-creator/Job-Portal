          ...
          <div className="space-y-4">
            ...
            <div className="pt-2 border-t border-zinc-100">
              <div className="flex items-center justify-between mb-3">
                ...
                <button onClick={addSection} className="inline-flex items-center gap-1 text-sm font-medium text-[#8b2df2] hover:underline">
        ...
        <>
          {loading ? (
            ...
            <div className="bg-white rounded-2xl shadow-soft p-12 text-center">
              ...
              <p className="text-zinc-500">No jobs yet. Click "New Job" to create your first listing.</p>
            </div>
          ) : (
            <div className="space-y-3">
              {jobs.map((job) => (
                <div key={job.id} className="bg-white rounded-2xl shadow-soft p-5 flex items-start justify-between gap-4">
                  ...
                  <div className="flex items-center gap-1 shrink-0">
                    <button onClick={() => openEdit(job)} className="p-2 text-zinc-400 hover:text-[#8b2df2]"><Pencil className="w-4 h-4" /></button>
